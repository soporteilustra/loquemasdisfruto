              ...
              <form class="" action="../controller/authenticate.php" method="post">
               ...
               ?>
                <div class="form-group  <?php echo $classgroup ?>">
                  ...
                  <input type="text" class="form-control <?php echo $class ?>" required="" name="user" autofocus="" placeholder="usuario">
                </div>
                <div class="form-group  <?php echo $classgroup ?>">
                  <input type="password" class="form-control <?php echo $class ?>" required="" name="password" placeholder="contraseña">
                  <div class="form-control-feedback">
                    <?php echo $msg ?>
                  </div>
                </div>
                <div class="form-group">
                  <button type="submit" class="btn btn-danger btn-smart" name="button">Descargar</button>
                </div>
              </form>
            </div>
